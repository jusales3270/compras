...
export function Background() {
    return (
        <div className="absolute inset-0 w-full overflow-hidden bg-[#f1f5f9] pointer-events-none z-0">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    height={40}
                    rotate={-25}
                    gradient="from-cyan-600/[0.08]"
                    className="left-[20%] md:left-[25%] top-[5%] md:top-[10%]"
                />
            </div>

            <div className="absolute inset-0 bg-gradient-to-t from-[#f1f5f9] via-transparent to-[#f1f5f9]/80 pointer-events-none" />
        </div>
    );
}
